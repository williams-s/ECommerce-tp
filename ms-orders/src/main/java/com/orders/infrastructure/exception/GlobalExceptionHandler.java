...
public class GlobalExceptionHandler {
    ...
    /**
     * Gère les exceptions InvalidOrderStatusException (400)
     */
    ...
    public ResponseEntity<ErrorResponse> handleInvalidOrderStatusException(
        ...
        log.error("Statut de commande invalide: {}", ex.getMessage());
    ...
    /**
     * Gère les exceptions ProductOutOfStockException (400)
     */
    ...
    public ResponseEntity<ErrorResponse> handleProductOutOfStockException(
        ...
        log.error("Produit en rupture de stock: {}", ex.getMessage());
    ...
    /**
     * Gère les exceptions CommandCancelleOrDeliveredException (409)
     */
    @ExceptionHandler(CommandCancelleOrDeliveredException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<ErrorResponse> handleCommandCancelleOrDeliveredException(
            CommandCancelleOrDeliveredException ex,
            HttpServletRequest request) {

        log.error("Commande annulée ou livrée: {}", ex.getMessage());
    ...
    /**
     * Gère les exceptions ExternalServiceDownException (503)
     */
    ...
    public ResponseEntity<ErrorResponse> handleExternalServiceDownException(
            ExternalServiceDownException ex,
            HttpServletRequest request) {

        log.error("Service externe inaccessible: {}", ex.getMessage());
